...
#            2.我们的部件共有的行为是：刷会员卡
#
#            3.部件之间的层次关系，也就是店面的层次关系是，
#              总店下有分店、分店下可以拥有加盟店。
#
# 有了我们这几个必要条件后，我的要求就是目前店面搞活动当我在总店刷卡后，
# 就可以累积相当于在所有下级店面刷卡的积分总额，设计的代码如下
...
# 这样在累积所有子店面积分的时候，就不需要去关心子店面的个数了，
# 也不用关系是否是叶子节点还是组合节点了，也就是说不管是总店刷卡，
# 还是加盟店刷卡，都可以正确有效的计算出活动积分。
#
# 什么情况下使用组合模式
#
# 引用大话设计模式的片段：
